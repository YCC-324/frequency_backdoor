...
# parser.add_argument('--target_ch', type=int, default=0, help='the downstream task')
...
for target_ch in range(3):
    ...
    topn_index = frequency_cov[target].argsort()[::-1][0:topn]  #largest
    # print(topn_index)
...
index_final = idx_score.argsort()[::-1][0:3]
