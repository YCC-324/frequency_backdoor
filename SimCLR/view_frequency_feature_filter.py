...
parser.add_argument('--dataset_name', type=str, default='imagenet', help='the downstream task')
...
if dataset_name == 'imagenet':
    train_image_paths,train_labels = get_dataset_imagenet('./dataset/imagenet/train/', max_num)    
else:
    train_image_paths,train_labels = get_dataset('../SimCLR/dataset/'+dataset_name+'/train/')
...
for train_image_path in train_image_paths:
    img = Image.open(train_image_path).convert('RGB').resize((224,224))
    img = np.array(img)
    # print(img.shape)
